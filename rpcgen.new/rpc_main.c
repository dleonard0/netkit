 ...
 */
char main_rcsid[] =
  "$Id: rpc_main.c,v 1.2 1996/07/15 19:31:27 dholland Exp $";
...
static void s_output(int argc, char *argv[], char *infile, char *define, 
		     int extend,  char *outfile, int nomain, int netflag);
...
static void svc_output(char *infile, char *define, int extend, char *outfile);
static void clnt_output(char *infile, char *define, int extend, char *outfile);
