 ...
 */
char rcsid[] = 
  "$Id: rpcinfo.c,v 1.9 1999/12/12 18:05:00 dholland Exp $";
...
static u_long	getvers(const char *arg);
static void	get_inet_address(struct sockaddr_in *addr, const char *host);
