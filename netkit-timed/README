This is netkit-timed-0.17 for Linux.

This package updates netkit-timed-0.16.
...
Note: for general use, xntpd is recommended. timed should only be used
in cases where xntpd, or another ntp daemon, cannot be used.
...
Security:
	...
	netkit-timed-0.16. Versions prior to netkit-timed-0.10
